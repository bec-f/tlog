...
#include <stdio.h>
#include <string.h>
#include </home/vagrant/tlog_fresh-start/include/tlog/pkt.h>
#include </home/vagrant/tlog_fresh-start/include/tlog/sink.h>
#include </home/vagrant/tlog_fresh-start/include/tlog/rate_limit_sink.h>
                ...
                const struct tlog_pkt_pos *end)
{
    ...
    if(rate_limit_sink->prev_pkt->type != TLOG_PKT_TYPE_IO || rate_limit_sink->rate == 0){
        ...
        uint64_t time_change = (pkt->timestamp.tv_sec - rate_limit_sink->prev_pkt.tv_sec) * 1000000
                               + (pkt->timestamp.tv_nsec - rate_limit_sink->prev_pkt.tv_nsec)/1000;
